...
void lm_ggml_quantize_init(enum lm_ggml_type type) {
    ...
    switch (type) {
        ...
        case LM_GGML_TYPE_IQ1_M:   lm_lm_iq2xs_init_impl(type); break;
        case LM_GGML_TYPE_IQ3_XXS: lm_lm_iq3xs_init_impl(256); break;
        case LM_GGML_TYPE_IQ3_S:   lm_lm_iq3xs_init_impl(512); break;
        default: // nothing
            break;
    }
...
void lm_ggml_quantize_free(void) {
    ...
    lm_lm_iq2xs_free_impl(LM_GGML_TYPE_IQ2_XXS);
    lm_lm_iq2xs_free_impl(LM_GGML_TYPE_IQ2_XS);
    lm_lm_iq2xs_free_impl(LM_GGML_TYPE_IQ1_S);
    lm_lm_iq3xs_free_impl(256);
